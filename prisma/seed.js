...
const { PrismaClient, TrainingTimeSlot, TrainingType, UserRole } = require('../libs/shared-data-access/src/lib/generated');
...
// Inline constants from shared-constants
...
function generateTestPassword(role) {
  return TEST_PASSWORDS[role] || generateStrongPassword();
}
...
async function createCustomers(customerCount, trainingTypes) {
...
async function createTrainers(trainerCount, trainingTypes) {
...
async function createAdmins(adminCount) {
...
async function createTrainingSessions(trainers) {
...
async function createCoinsPackages() {
...
async function createRandomBookings(customers) {
